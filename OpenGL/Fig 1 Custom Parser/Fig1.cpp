...
// Global variable to control the rotation speed
...
bool ObjectLoader(const char *path) {
    ...
    while (1) {
        ...
        //READ MTL FILE
        if (strcmp(lineHeader, "HN_GrimmChild_Anim_12frames_solidify_subdiv_final.mtl") == 0) {
...
int main(int argc, char **argv) {
    bool res = ObjectLoader("./HN_GrimmChild_Anim_12frames_solidify_subdiv_final.obj");
